...
export default function FaseCincoPage() {
  ...
  const guardarRevision = async () => {
    ...
    let documentoColumna = "General / Fase V"
    ...
    if (tipoComentario === "especifico") {
      ...
      documentoColumna = "Comentario General de la Fase V"
    }
      ...
      <div className="flex flex-col xl:flex-row justify-between items-stretch gap-6 bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        <div className="flex flex-col justify-center space-y-3">
          ...
          <p className="text-sm md:text-base text-slate-500 max-w-2xl pt-1 leading-relaxed font-medium">
            Despliegue a producción, entrega formal del producto, transferencia tecnológica y cierre del proyecto AJUPTEL Carabobo.
          </p>
        </div>
        ...
        <div className="relative">
          <textarea 
            ...
            placeholder={tipoComentario === "especifico" 
              ...
              : "Escribe un comentario general sobre toda la Fase V..."
            }
